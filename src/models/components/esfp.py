...
class ESFPNetStructure(nn.Module):
    ...
    def _init_weights(self):
        ...
        if model_type == 'B0':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b0.pth')
        if model_type == 'B1':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b1.pth')
        if model_type == 'B2':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b2.pth')
        if model_type == 'B3':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b3.pth')
        if model_type == 'B4':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b4.pth')
        if model_type == 'B5':
            pretrained_dict = torch.load('/data/AI/ngocpt/Lang/Lung-Nodule-Segmentation/src/models/Pretrained/mit_b5.pth')
